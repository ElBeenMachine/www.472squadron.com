import { Box, Flex, Image, Text, IconButton, Button, Stack, Collapse, Icon, Popover, PopoverTrigger, PopoverContent, useColorModeValue, useBreakpointValue, useDisclosure } from '@chakra-ui/react';
        ...
        <Box>
            <Flex bg={useColorModeValue('white', 'gray.800')} color={useColorModeValue('gray.600', 'white')} minH={'60px'} py={{ base: 2 }} px={{ base: 4 }} borderBottom={1} borderStyle={'solid'} borderColor={useColorModeValue('gray.200', 'gray.900')} align={'center'}>
                ...
                <Flex flex={{ base: 1 }} justify={{ base: 'center', md: 'start' }} alignItems={'center'}>
                    <Flex justifyContent={useBreakpointValue({ base: 'center', md: 'flex-start' })}>
                        <Image maxH={"52px"} src='/img/nav-logo.png'  />
                    </Flex>
                ...
                <Stack flex={{ base: 1, md: 0 }} justify={'flex-end'} direction={'row'} spacing={6}>
                    <Button as={'a'} display={{ base: 'none', md: 'inline-flex' }} fontSize={'sm'} fontWeight={600} color={'white'} bg={colourScheme.primaryAccent} href={'https://www.raf.mod.uk/aircadets/interested-in-joining-as-a-cadet/?squadronno=472'} target={"_blank"} _hover={{ bg: colourScheme.primaryHover }}>
                        Join As a Cadet
                    </Button>
                    <Button as={'a'} display={{ base: 'none', md: 'inline-flex' }} fontSize={'sm'} fontWeight={600} color={'white'} bg={colourScheme.primaryAccent} href={'https://www.raf.mod.uk/aircadets/interested-in-joining-as-a-volunteer/?squadronno=472'} target={"_blank"} _hover={{ bg: colourScheme.primaryHover }}>
                        Join As a Volunteer
                    </Button>
                </Stack>
            </Flex>
